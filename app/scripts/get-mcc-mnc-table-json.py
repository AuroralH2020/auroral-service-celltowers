# Taken from: https://github.com/musalbas/mcc-mnc-table/blob/57dd1f14e057d7a3f06185762b7e4a424a2b720d/get-mcc-mnc-table-json.py
# Extended with mcc filter to EU countries only
...
def prettify_json(json_data: str) -> str:
    ...
    # filter out if mcc not starts with 2
    json_object = [x for x in json_object if x['mcc'].startswith('2')]
